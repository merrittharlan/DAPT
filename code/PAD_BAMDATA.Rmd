...
#Save
saveRDS(Athabasca_R1_data, file = "../input/PAD/Athabasca_R1_data.rds")
saveRDS(Athabasca_R1_full_data, file = "../input/PAD/Athabasca_R1_full_data.rds")
saveRDS(Athabasca_R2_data, file = "../input/PAD/Athabasca_R2_data.rds")
saveRDS(Athabasca_R2_data, file = "../input/PAD/Athabasca_R2_full_data.rds")
...
saveRDS(Coupe_data, file = "../input/PAD/Coupe_data.rds")
saveRDS(Coupe_full_data, file = "../input/PAD/Coupe_full_data.rds")
...
Fletcher_corr_Q <- Fletcher_qobs_df
...
Fletcher_full_data = PAD_bamdata(WSE_all = Fletcher_WSE[c(1:4,6,8)], WSE_Q = Fletcher_WSE_corrQ[,c(1:3)], bamdata = Fletcher_data,
                                      xvec = rev(Fletcher_xvec[c(3:5)]), rivname = "Fletcher", Q = Fletcher_corr_Q)

saveRDS(Fletcher_data, file = "../input/PAD/Fletcher_data.rds")
saveRDS(Fletcher_full_data, file = "../input/PAD/Fletcher_full_data.rds")
...
Mamawi_full_data = PAD_bamdata(WSE_all = Mamawi_WSE, WSE_Q = Mamawi_WSE_corrQ, bamdata = Mamawi_data,
                                      xvec = Mamawi_xvec, rivname = "Mamawi", Q = Mamawi_corr_Q)

saveRDS(Mamawi_data, file = "../input/PAD/Mamawi_data.rds")
saveRDS(Mamawi_full_data, file = "../input/PAD/Mamawi_full_data.rds")
...
saveRDS(QF_data, file = "../input/PAD/QF_data.rds")
saveRDS(QF_full_data, file = "../input/PAD/QF_full_data.rds")
...
Rochers_R2_full_data = PAD_bamdata(WSE_all = Rochers_WSE, WSE_Q = Rochers_WSE_corrQ[c(1:14, 33:45), 4:5], 
                                          bamdata = Rochers_R2_data,
                                          xvec = Rochers_xvec[4:5], rivname = "Rochers", Q = Rochers_corr_Q[c(1:14, 33:45),])

saveRDS(Rochers_R1_data, file = "../input/PAD/Rochers_R1_data.rds")
saveRDS(Rochers_R2_data, file = "../input/PAD/Rochers_R2_data.rds")

saveRDS(Rochers_R1_full_data, file = "../input/PAD/Rochers_R1_full_data.rds")
saveRDS(Rochers_R2_full_data, file = "../input/PAD/Rochers_R2_full_data.rds")
...
#Save
saveRDS(Embarras_data, file = "../input/PAD/Embarras_data.rds")
saveRDS(Embarras_full_data, file = "../input/PAD/Embarras_full_data.rds")
...
#Save
saveRDS(Limon_data, file = "../input/PAD/Limon_data.rds")
saveRDS(Limon_full_data, file = "../input/PAD/Limon_full_data.rds")
...
#Save
saveRDS(Richardson_data, file = "../input/PAD/Richardson_data.rds")
saveRDS(Richardson_full_data, file = "../input/PAD/Richardson_full_data.rds")
