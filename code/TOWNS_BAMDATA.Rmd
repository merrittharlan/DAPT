...
#locator(n = 4)
Sacramento_R1_upper_l <- c(33.6, 67.9, 19.7, 29.4, 23.0, 23.5, 29.4,  1.7, 2.2)
Sacramento_R1_lower_l <- c(56.8, 71.4, 28.3, 35.3, 25.5, 28.9, 33.7, 23.4, 30.6)
Sacramento_R1_lower_r <- c(68.6, 75.4, 71.6, 50.2, 39.9, 44.4, 43.4, 55.2, 49.0)
Sacramento_R1_upper_r <- c(86.2, 79.2, 76.2, 53.7, 43.9, 53.8, 50.0, 65.6, 61.7)

Sacramento_R1_elev_prof_corr <- Sacramento_R1_elev_prof[c(1:4, 4, 8, 8, 8, 9, 10)]
Sacramento_rch1_elev_prof_NED_corr[[6]] <- Sac_rch1_elev_prof_NED[[6]] - 3.5
Sacramento_rch1_elev_prof_NED_corr[[7]] <- Sac_rch1_elev_prof_NED[[7]] - 3
...
xvec <-calc_xvec(Sacramento_R1_PT_coords_sp, Sacramento_R1_cl)

Sacramento_R1_WSE_daily <- readRDS("../input/TOWNS/WSE/Sacramento_R1_WSE_Q_daily.rds")
Sacramento_R1_width_daily <- t(calc_width(h = Sacramento_R1_WSE_daily[,c(3:ncol(Sacramento_R1_WSE_daily))], elev_prof = Sacramento_R1_elev_prof, 
